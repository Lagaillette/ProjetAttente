<html>
    <body>
        <div class="entete centrage">Aide</div>
        <div class="indices" style="color : gray;">
        <p class="col-xs-10 col-xs-offset-1 centrage" style="margin-bottom: 40px">Voici les choses essentielles à savoir lors de l'utilisation de ce site :</p>
        ...
        <p class="col-xs-10 col-xs-offset-1">-Soit le libellé "inactif" qui veut dire que le médecin concerné n'utilise pas l'application en ce moment</p>
